/* RATHOD HUB • PW-style subject launcher with native PW App handoff */
(function(){
'use strict';
if(window.__RH_PW_SUBJECT_LAUNCHER__)return;window.__RH_PW_SUBJECT_LAUNCHER__=1;
const SUBJECTS=[
 {name:'Biology',icon:'🧬',detail:'Botany • Zoology',color:'from-emerald-600 to-lime-600'},
...
function run(){window.rhOpenPW=openPW;enhance()}
