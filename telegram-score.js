...
const extras=()=>{
  add('rh-archive-icon-fix-script','rathod-archive-icon-fix.js?v=4');
  add('rh-master-control-script','rathod-master-control.js?v=6');
  add('rh-song-library-script','rathod-song-library.js?v=6');
  add('rh-song-layout-fix-script','rathod-song-layout-fix.js?v=5');
  add('rh-mentor-room-script','rathod-mentor-room.js?v=4');
  add('rh-study-room-fix-script','rathod-study-room-fix.js?v=4');
};
