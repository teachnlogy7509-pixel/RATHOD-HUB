...
const extras=()=>{
  ...
  add('rh-song-library-script','rathod-song-library.js?v=10');
  ...
  add('rh-adminpanel-click-fix-script','rathod-adminpanel-click-fix.js?v=1');
  ...
  add('rh-focus-tap-fix-script','rathod-focus-tap-fix.js?v=1');
  ensureFocusScripts();
