...
This Android wrapper preserves the existing web app and adds an optional Focus Mode. Alarm is intentionally not included.

## Build
Open this `android/` folder in Android Studio, sync Gradle, and build the debug APK.
